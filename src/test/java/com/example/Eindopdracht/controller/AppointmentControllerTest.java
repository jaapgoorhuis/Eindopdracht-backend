...
class AppointmentControllerTest {
    ...
    public void setUp() {
        ...
        carDto1 = new CarDto(1L, "Ford escord","04-23G-G");
        carDto2 = new CarDto(1L, "BMW","04-23G-G");

        carInputDto1 = new CarInputDto(1L, "Ford escord","04-23G-G");
        carInputDto2 = new CarInputDto(1L,"BMW","04-23G-G");
        ...
        appointmentDto3 = new AppointmentDto(1L, LocalDate.of(2022,02,02),"123","finished","reparatie",car1);
        appointmentDto2 = new AppointmentDto(1L, LocalDate.of(2022,05,06),"","not_finished","keuring",car1);

        appointmentInputDto1 = new AppointmentInputDto(1L, LocalDate.of(2022,02,02),"123","finished","reparatie", car1);
    ...
    void createAppointment() throws Exception {
        when(service.createAppointment(any((AppointmentInputDto.class)))).thenReturn(appointmentDto1);
